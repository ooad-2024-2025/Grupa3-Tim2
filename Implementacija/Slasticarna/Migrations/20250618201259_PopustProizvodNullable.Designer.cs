...
namespace Slasticarna.Migrations
{
    ...
    [Migration("20250618201259_PopustProizvodNullable")]
    partial class PopustProizvodNullable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PopustProizvod", b =>
                {
                    ...
                    b.HasKey("PopustID", "ProizvodID");

                    b.HasIndex("ProizvodID");

                    b.ToTable("PopustProizvodi", (string)null);
                });
            ...
            modelBuilder.Entity("Slasticarna.Models.PraznicnaPonuda", b =>
                {
                    b.Property<int>("PraznicnaPonudaID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("PraznicnaPonudaID"));
                    ...
                    b.HasKey("PraznicnaPonudaID");

                    b.ToTable("PraznicnaPonuda", (string)null);
                });

            modelBuilder.Entity("Slasticarna.Models.PraznicnaPonudaProizvod", b =>
                {
                    b.Property<int>("PraznicnaPonudaID")
                        .HasColumnType("int");
                    ...
                    b.HasKey("PraznicnaPonudaID", "ProizvodID");

                    b.HasIndex("ProizvodID");

                    b.ToTable("PraznicnaPonudaProizvodi", (string)null);
                });
            ...
            modelBuilder.Entity("Slasticarna.Models.PraznicnaPonudaProizvod", b =>
                {
                    b.HasOne("Slasticarna.Models.PraznicnaPonuda", "PraznicnaPonuda")
                        .WithMany("Proizvodi")
                        .HasForeignKey("PraznicnaPonudaID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
